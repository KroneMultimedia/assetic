...
class AsseticTokenParser extends AbstractTokenParser
{
    ...
    //protected function createBodyNode(Assetic\Asset\AssetInterface $asset, Twig\Node\Node $body, array $inputs, array $filters, $name, array $attributes = array, $lineno = 0, $tag = NULL)
    {
